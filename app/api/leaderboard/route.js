  ...
  try {
    ...
    const leaderboard = users
      .map((user) => {
        ...
        // Rank by combined performance across the platform:
        // solved is the biggest driver, accuracy breaks ties strongly,
        // and attempted rewards consistent practice without overpowering solves.
        const score =
